...
# Load pre-trained GPT-2 XL model (with your modifications)
...
train_dataset = prepare_dataset(dataset["train"].select(range(0,100)), "train")#.select(range(0,100))

print("Preprocessing validation data...")
eval_dataset = prepare_dataset(dataset["validation"].select(range(0,100)), "validation")#.select(range(0,100))
